...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-cream font-sans">
      ...
      {/* Mobile Header */}
      <header className="fixed left-0 right-0 top-0 z-30 flex items-center justify-between bg-white/80 px-4 py-3 backdrop-blur-md lg:hidden">
      ...
      {/* Main Content */}
      <main className="pb-20 pt-14 lg:ml-64 lg:pb-6 lg:pl-6 lg:pr-6 lg:pt-6">
      ...
      {/* Mobile Bottom Tab */}
      <nav className="fixed bottom-0 left-0 right-0 z-30 border-t border-gray-100 bg-white/90 backdrop-blur-md lg:hidden">
